    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white border border-gray-200 rounded-2xl p-8 card-hover text-center">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 card-hover text-center">
              <div className="bg-gray-900 w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-6">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <a href="http://localhost:3002/login" className="px-8 py-4 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition-all duration-200 text-lg inline-block">
            Get Started Free
          </a>
        </div>
      </section>
